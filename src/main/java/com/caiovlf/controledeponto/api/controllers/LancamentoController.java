...
public class LancamentoController {
	...
	public ResponseEntity<Response<LancamentoDto>> listarPorId(@PathVariable("id") Long id){
		...
		if(!lancamento.isPresent()) {
			log.info("Lançamento não encontrado por ID: {}", id);
	...
	public ResponseEntity<Response<LancamentoDto>> adicionar(@Valid @RequestBody LancamentoDto lancamentoDto,
		...
		if(result.hasErrors()) {
			log.error("Error ao validar Lançamento: {} ", result.getAllErrors());
	...
	/**
	 * Valida um funcionário verificando se ele é existente e válido 
	 * no sistema
	 * 
	 * @param lancamentoDto
	 * @param result
	...
	/**
	 * Converte Lancamento para o seu DTO
	 * 
	 * @param lancamento
